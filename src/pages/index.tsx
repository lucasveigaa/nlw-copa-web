...
import homeCelulares from "../assets/home-celulares.png";
import logoImg from "../assets/logo.svg";
import exampleAvatars from "../assets/avatares.png";
...
export default function Home({ poolCount, guessCount, userCount }: HomeProps) {
  ...
  return (
    <div className="max-w-6xl mx-auto my-10 grid grid-cols-2 items-center gap-28">
      <main>
        ...
        <div className="mt-10 flex items-center gap-2">
          <Image src={exampleAvatars} quality={100} alt="" />
